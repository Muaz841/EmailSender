...
namespace EmailSender.Migrations
{
    ...
    [Migration("20241025135506_initialemail")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EmailSender.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EmailSender.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("EmailSender.EmailSender.EmailSenderEntities.EmailQueue", b =>
                {
                    ...
                    b.Property<string>("EmailPriority")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("EmailSender.EmailSender.EmailSenderEntities.EmailTemplate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("EmailSender.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("EmailSender.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("EmailSender.Authorization.Roles.Role", b =>
                {
                    ...
                    b.HasOne("EmailSender.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("EmailSender.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
