...
{
    public abstract class EmailSenderWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static EmailSenderWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(EmailSenderWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<EmailSenderDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<EmailSenderDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<EmailSenderDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<EmailSenderDbContext, Task<T>> func)
        {
            T result;
